...
- [ ] **GET /pokemons**: -`http://localhost:3001/pokemons`
- [ ] **GET /pokemons/{idPokemon}**: -`http://localhost:3001/pokemons/1`
- [ ] **GET /pokemons?name="..."**: -`http://localhost:3001/pokemons?name=charmander`
- [ ] **GET /types**: `-http://localhost:3001/types`
- [ ] **POST /pokemons**: -`http://localhost:3001/pokemons`
...
> y puede llenar como este ejemplo :
    ...
    "img":"https://raw.githubusercontent.com/kenpulicorre/PI-Pokemon-main/main/client/src/images/1-gor.png"}
